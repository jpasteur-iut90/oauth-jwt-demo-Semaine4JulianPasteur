<template>
  <div class="container">
    ...
    <button @click="socialLogin('google')" type="button" class="oauth-btn google-btn">
    ...
    <button @click="socialLogin('github')" type="button" class="oauth-btn github-btn">
      <span class="oauth-icon">GH</span>
      Se connecter avec GitHub
    </button>

    <button @click="socialLogin('discord')" type="button" class="oauth-btn discord-btn">
      <span class="oauth-icon">DS</span>
...
export default {
  ...
  methods: {
    ...
    socialLogin(provider) {
      ...
      const target = `${import.meta.env.VITE_API_URL}/auth/${provider}`;
